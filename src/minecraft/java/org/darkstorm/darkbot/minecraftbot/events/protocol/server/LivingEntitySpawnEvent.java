...
public class LivingEntitySpawnEvent extends MetaEntitySpawnEvent
{
	...
	public LivingEntitySpawnEvent(int entityId,
			LivingEntitySpawnLocation location,
			LivingEntitySpawnData spawnData,
	...
	public static class LivingEntitySpawnLocation extends RotatedSpawnLocation
	{
		...
		public LivingEntitySpawnLocation(double x, double y, double z,
				double yaw, double pitch, double headYaw)
		{
	...
	public static class LivingEntitySpawnData
	{
		...
		public LivingEntitySpawnData(int type, double velocityX,
