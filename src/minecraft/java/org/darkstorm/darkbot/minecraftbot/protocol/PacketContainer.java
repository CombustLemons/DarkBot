...
public final class PacketContainer
{
	...
	public Object getMethod(String name, Class<?>[] argumentTypes,
			Object... arguments)
	{
		try
		{
			return packetClass.getDeclaredMethod(name)
					.invoke(packet, arguments);
		} catch (IllegalAccessException exception)
		{
	...
	public boolean invokeMethodBoolean(String name, Class<?> argumentTypes,
			Object... arguments)
	{
		try
		{
			return (Boolean) packetClass.getDeclaredMethod(name).invoke(packet,
					arguments);
		} catch (IllegalAccessException exception)
		{
			throw new IllegalArgumentException("Inaccessible method", exception);
	...
	public byte invokeMethodByte(String name, Class<?> argumentTypes,
			Object... arguments)
	{
		try
		{
			return (Byte) packetClass.getDeclaredMethod(name).invoke(packet,
					arguments);
		} catch (IllegalAccessException exception)
		{
			throw new IllegalArgumentException("Inaccessible method", exception);
	...
	public char invokeMethodChar(String name, Class<?> argumentTypes,
			Object... arguments)
	{
		try
		{
			return (Character) packetClass.getDeclaredMethod(name).invoke(
					packet, arguments);
		} catch (IllegalAccessException exception)
		{
			throw new IllegalArgumentException("Inaccessible method", exception);
	...
	public short invokeMethodShort(String name, Class<?> argumentTypes,
			Object... arguments)
	{
		try
		{
			return (Short) packetClass.getDeclaredMethod(name).invoke(packet,
					arguments);
		} catch (IllegalAccessException exception)
		{
			throw new IllegalArgumentException("Inaccessible method", exception);
	...
	public int invokeMethodInt(String name, Class<?> argumentTypes,
			Object... arguments)
	{
		try
		{
			return (Integer) packetClass.getDeclaredMethod(name).invoke(packet,
					arguments);
		} catch (IllegalAccessException exception)
		{
			throw new IllegalArgumentException("Inaccessible method", exception);
	...
	public long invokeMethodLong(String name, Class<?> argumentTypes,
			Object... arguments)
	{
		try
		{
			return (Long) packetClass.getDeclaredMethod(name).invoke(packet,
					arguments);
		} catch (IllegalAccessException exception)
		{
			throw new IllegalArgumentException("Inaccessible method", exception);
	...
	public float invokeMethodFloat(String name, Class<?> argumentTypes,
			Object... arguments)
	{
		try
		{
			return (Float) packetClass.getDeclaredMethod(name).invoke(packet,
					arguments);
		} catch (IllegalAccessException exception)
		{
			throw new IllegalArgumentException("Inaccessible method", exception);
	...
	public double invokeMethodDouble(String name, Class<?> argumentTypes,
			Object... arguments)
	{
		try
		{
			return (Double) packetClass.getDeclaredMethod(name).invoke(packet,
					arguments);
		} catch (IllegalAccessException exception)
		{
			throw new IllegalArgumentException("Inaccessible method", exception);
