...
public class LegacyAuthService implements AuthService
{
	...
	@Override
	public LegacySession login(String username, String password)
	...
	@Override
	public LegacySession login(String username, String password, Proxy proxy)
			throws AuthenticationException, IOException
	{
		String parameters = String.format(LOGIN_URL_PARAMETERS,
				encodeUtf8(username), encodeUtf8(password), LOGIN_VERSION);
	...
	@Override
	public void authenticate(Session session, String serverId)
			throws AuthenticationException, IOException
	{
	...
	@Override
	public void authenticate(Session session, String serverId, Proxy proxy)
			throws AuthenticationException, IOException
	{
		...
		URL url = new URL(String.format(SERVER_AUTH_URL,
				encodeUtf8(legacySession.getUsername()),
				encodeUtf8(legacySession.getSessionId()), encodeUtf8(serverId)));
		URLConnection connection = proxy == null ? url.openConnection() : url
